...
const ProductItem = async (props: Props) => {
                ...
                {products.map((product) => (
                    <div key={product.id}>
                        <Link href={`/dashboard/${product.id}`}>
                            <div className='relative rounded-lg w-[250px] h-[300px]'>
                                <Image fill={true} src={product.images.split(',')[0]} className=' object-cover object-top rounded-lg' alt="" />
                            </div>
